...
export default function PersonalAccidentInsuranceList({ isArchive = false }: { isArchive?: boolean } = {}) {
  ...
  const handleExportExcel = async () => {
    ...
    try {
      ...
      let allDocs: PersonalAccidentInsuranceDocument[] = [...documents];
  ...
  return (
    <section className="users-management">
                    ...
                    {paginatedDocuments.map((doc) => {
                      ...
                      return (
                        ...
                        <div className="action-buttons">
                          <button
                            onClick={() => {
                              window.open(`${API_BASE_URL}/personal-accident-insurance-documents/${doc.id}/print?t=${Date.now()}`, '_blank');
                            }}
      ...
      <InsuranceTermsModal
        ...
        insuranceTypeKey="accident"
        insuranceTypeName="تأمين الحوادث الشخصية"
      />
          {cancellationDoc && (
        <CancelDocumentModal
