...
type TravelInsuranceDocument = {
  ...
  residence_duration?: number | string | null;
  premium: number;
    ...
    return (
      <section className="users-management">
        <div className="users-breadcrumb">
          <span>وثائق تأمين المسافرين / عرض وثيقة</span>
        </div>
        ...
        <div className="engineer-financial-details-container">
          <div className="engineer-financial-details-header">
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <button
                ...
                onClick={() => navigate(`/travel-insurance-documents/${id}/edit`)}
              >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginTop: '24px' }}>
            ...
            <div className="form-section">
              ...
              {document.residence_duration !== null && document.residence_duration !== undefined && document.residence_duration !== '' && (
                <div className="form-group">
