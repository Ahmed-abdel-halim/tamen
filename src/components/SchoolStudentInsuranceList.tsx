...
export default function SchoolStudentInsuranceList() {
  ...
  const fetchDocuments = async () => {
    try {
      ...
      const res = await fetch('/api/school-student-insurance', { headers });
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      const res = await fetch(`/api/school-student-insurance/${deleteConfirm.id}`, { 
        method: 'DELETE',
        headers: {
  ...
  return (
    <section className="users-management">
      <div className="users-breadcrumb">
        <span>تأمين حماية طلاب المدارس / قائمة الوثائق</span>
      </div>
                      ...
                      <div className="action-buttons">
                        <button
                          onClick={() => {
                            ...
                            iframe.src = `/api/school-student-insurance/${doc.id}/print`;
