...
export default function CreateTravelInsurance() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/travel-insurance-documents`, {
        method: 'POST',
        headers,
        body: JSON.stringify({
  ...
  return (
    <section className="users-management">
      <div className="users-breadcrumb">
        <span>وثائق تأمين المسافرين / إضافة وثيقة</span>
      </div>
        ...
        <div className="form-page-container">
          <div className="form-page-header">
            <h2 className="form-page-title">
              إضافة وثيقة تأمين مسافرين جديدة
            </h2>
            <button 
                    ...
                    if (authorizedDocuments && authorizedDocuments.length > 0) {
                      ...
                      if (allowedTypes.length > 0 && !allowedTypes.find(t => t.value === formData.insurance_type)) {
                        setTimeout(() => {
                          setFormData(prev => ({ 
                            ...prev, 
                            insurance_type: allowedTypes[0].value as any,
                            geographic_area: '',
                            duration: '',
                            premium: '0',
                            residence_type: '',
