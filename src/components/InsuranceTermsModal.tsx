...
4. أي تعديل أو كشط في بيانات الوثيقة يجعلها ملغاة وباطِلة.`,
  ...
  travel: `1. تغطي هذه الوثيقة حالات الطوارئ الطبية والحوادث الشخصية أثناء السفر خارج بلد الإقامة وفق جدول المنافع المرفق.
2. التغطية الطبية تشمل العلاج الطارئ والإقامة بالمستشفى والترحيل الطبي في الحالات الحرجة.
3. يتعين على المؤمن له الاتصال بمركز الخدمة والمساعدة المباشر فور حدوث أي طارئ طبي.
4. تستثنى من التغطية الأمراض المزمنة السابقة للتأمين والأنشطة والرياضات الخطرة غير المصرح بها.`,
