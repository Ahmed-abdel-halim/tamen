...
export default function CreateProfessionalLiabilityInsurance() {
  ...
  return (
    <section className="users-management">
      <div className="users-breadcrumb">
        <span>الإعدادات / تأمين المسؤولية المهنية (الطبية) / إضافة وثيقة</span>
      </div>
        ...
        <div className="form-page-container">
          <div className="form-page-header">
            <h2 className="form-page-title">
              إضافة وثيقة تأمين مسؤولية مهنية (طبية) جديدة
            </h2>
            <button 
