...
export default function MarineStructureInsuranceList({ isArchive = false }: { isArchive?: boolean } = {}) {
  ...
  const handleExportExcel = async () => {
    ...
    try {
      ...
      let allDocs: MarineStructureInsuranceDocument[] = [...documents];
      ...
      const columns = [
        ...
        { header: 'نوع الهيكل', key: 'structure_type', width: 20 },
      ...
      <div className="users-card">
        <div className="users-header">
          <div className="users-search-bar">
            <input
              type="text"
              placeholder="بحث برقم التأمين، اسم المؤمن، رقم الهاتف أو نوع الهيكل..."
              value={searchQuery}
          ...
          {!isArchive && (
            <button
              ...
              onClick={() => navigate('/marine-structure-insurance-documents/create')}
            >
                      ...
                      <tr key={doc.id}>
                        ...
                        <td>
                          <div className="action-buttons">
                            ...
                            <button
                              onClick={() => navigate(`/marine-structure-insurance-documents/${doc.id}`)}
                            ...
                            {isAdmin && (
                              <button
                                onClick={() => navigate(`/marine-structure-insurance-documents/${doc.id}/edit`)}
                    ...
                    <div key={doc.id} className="user-mobile-card">
                      <div className="user-mobile-header">
                        <div>
                          ...
                          <span className="user-mobile-number">تأمين الهياكل البحرية</span>
                        </div>
                      </div>
                      <div className="user-mobile-body">
                        ...
                        <div className="user-mobile-row">
                          <span className="user-mobile-label">نوع الهيكل:</span>
                          <span className="user-mobile-value">{doc.structure_type}</span>
                        </div>
                        <div className="user-mobile-row">
