  ...
  const handleExportExcel = async () => {
    ...
    try {
      ...
      try {
        ...
        let total = 0;
        let lastPage = 1;
        const fetchedDocs: InternationalInsuranceDocument[] = [];
        ...
        do {
          ...
          const rows: InternationalInsuranceDocument[] = json.data || [];
    ...
    <section className="users-management">
      ...
      {showCancelModal && (
        <CancelDocumentModal
          ...
          documentId={showCancelModal.id}
          documentNumber={showCancelModal.document_number}
          insuredName={showCancelModal.insured_name || ''}
          documentType="تأمين سيارات دولي"
          issueDate={showCancelModal.issue_date || ''}
          onSuccess={() => {
            fetchDocuments();
          }}
        />
