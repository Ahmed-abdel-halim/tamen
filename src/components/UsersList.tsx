...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { id: 'المطابقة والتحصيلات المالية', label: 'المطابقة والتحصيلات المالية' },
      { id: 'إدخال مبيعات نقاط البيع (POS)', label: 'إدخال مبيعات نقاط البيع (POS)' },
      { id: 'مطابقة مبيعات نقاط البيع (POS)', label: 'مطابقة مبيعات نقاط البيع (POS)' },
      ...
      { id: 'تقرير الإنتاجية المباشر', label: 'تقرير الإنتاجية المباشر للوكلاء' },
      ...
      { id: 'إلغاء تسديد التعويضات', label: 'إلغاء تسديد وصرف التعويضات' },
  ...
  },
  {
    ...
    permissions: [
      ...
      { id: 'إدارة الوكيل', label: 'إدارة الوكيل' },
      { id: 'كشف الحساب الشهري للوكيل', label: 'كشف الحساب الشهري للوكيل (إدارة الوكيل)' },
  ...
  },
  {
    ...
    permissions: [
      ...
      // الوثائق المنتهية ودليل الجهات الخارجية
      { id: 'الوثائق المنتهية', label: 'الوثائق المنتهية' },
      { id: 'أرشيف المستندات الإدارية', label: 'الوثائق المنتهية' },
